"""
Facet plot of train and validation loss trajectories vs step for the
epoch-capped experiments 41, 42, 43. One facet per training dataset
size; two lines per experiment (train_loss solid, val_loss dashed)
coloured by model. Independent x and y scales per facet so each
trajectory uses the full plotting area.
"""

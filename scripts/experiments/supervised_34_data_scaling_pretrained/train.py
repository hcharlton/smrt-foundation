"""
Data scaling experiment with pretrained encoder (exp 25 ssl_25_cpg_autoencoder).

Same grid and output format as supervised_33_data_scaling, but with a pretrained
encoder loaded before training. Uses two-stage fine-tuning (exp 27 style):

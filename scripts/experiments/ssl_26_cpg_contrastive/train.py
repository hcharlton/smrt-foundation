"""
Contrastive pretraining (InputMask + InfoNCE) on CpG data (labels discarded).

Head-to-head comparison with experiment 25 (autoencoder on same data).
Tests whether contrastive objective works when distribution mismatch is eliminated.
"""
...
def main():
    ...
    DEFAULT = {
        ...
        'temperature': 0.1, 'max_negatives': 256,
    }
    ...
    criterion = AgInfoNCE(temperature=float(c['temperature']), max_negatives=c.get('max_negatives', 256))

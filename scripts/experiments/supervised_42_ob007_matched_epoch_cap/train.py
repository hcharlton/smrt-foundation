"""
Data scaling with OB007 pretrained encoder (exp 29) using exp 41's exact
epoch-capped schedule. Single-stage: AdamW lr=3e-3 for all params. The ONLY
difference from exp 41 is encoder init — cleanest comparison to isolate
OB007 pretraining effect under fair training budgets.
"""

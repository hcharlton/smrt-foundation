"""
Masked autoencoder pretraining on CpG data (labels discarded).

Eliminates the triple mismatch between SSL training and probe evaluation:
same data distribution, same context length (32), same normalization.
"""

"""
SSL pretraining with improvements:
  - ZNorm log1p normalization (matching supervised pipeline)
  - Higher masking ratio (p_mask=0.15, mask_size=10)
  - Linear probe evaluation after each epoch (frozen encoder + linear head on labeled CpG data)
  - Model checkpointing
"""
...
def main():
    ...
    DEFAULT = {
        ...
        'batch_size': 64, 'epochs': 12, 'ds_limit': 2_000_000,
        'max_lr': 3e-4, 'temperature': 0.1, 'p_mask': 0.15,
        'mask_size': 10, 'weight_decay': 0.02, 'pct_start': 0.25,
    }
